...
export default function Employee() {
  ...
  const faqs = [
    ...
    {
      question:
        "기업에서 사용하는 ERP나 자금관리프로그램에도 자금 누수를 예방하는 기능이 있지 않나요?",
      answer:
        "일부 ERP나 자금관리 프로그램의 경우, 사용자별 권한을 분리하여 지출을 통제하거나 회계상 문제가 발생하면 경고하는 방식으로 자금 누수를 예방한다고 주장합니다. 그러나 이러한 방식은 감사시스템과 마찬가지로 CEO나 오너의 직접 확인이 어렵고, 조작이나 은폐에 취약하며, 다양한 방식의 자금 누수에 대처하거나 탐지하기 어렵다는 한계가 있습니다. 무엇보다 GOTCHOO는 작은 규모의 기업이나 비영리기관·단체·사업체에서도 사용할 수 있는, 범용성과 확장성이 뛰어난 프로그램입니다.",
    },
    {
