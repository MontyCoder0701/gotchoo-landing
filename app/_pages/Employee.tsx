            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="col-span-3 flex items-center gap-2">
                <Checkbox
                  id="c1"
                  name="concerns"
                  value="어떻게 자금 누수를 잡는지, 데모를 무료로 보고 싶어요."
                />
                <label htmlFor="c1" className="text-sm text-muted-foreground">
                  어떻게 자금 누수를 잡는지, 데모를 무료로 보고 싶어요.
                </label>
              </div>
              <div className="col-span-3 flex items-center gap-2">
                <Checkbox
...
export default function Employee() {
  const miniFeatures = [
    ...
    {
      title: "자금 누수를 골라내는 강력한 알고리즘",
      description:
        "실제 사례를 기반으로 전문가들이 연구한 패턴과 알고리즘을 결합하여 자금 누수를 선별합니다.",
      image: "/shield.png",
      reverse: true,
    },
    {
      title: "언제 어디서나, 바로 알림",
      description:
        "자금 누수가 발생하면 실시간 알림으로 빠르게 대응할 수 있습니다.",
      image: "/chat.png",
      reverse: false,
    },
  ];
  ...
  const features = [
    ...
    },
    {
      title: "언제 어디서나, 바로 알림",
      description:
        "자금 누수가 발생하면 실시간 알림으로 빠르게 대응할 수 있습니다. 기업 대표나 담당자에게 카카오톡 알림 메시지와 이메일로 즉시 통보됩니다.",
  ...
  const faqs = [
    ...
    {
      question:
        "기업에서 사용하는 ERP나 자금관리프로그램에도 자금 누수을 예방하는 기능이 있지 않나요?",
      answer:
        "일부 ERP나 자금관리 프로그램의 경우, 사용자별 권한을 분리하여 지출을 통제하거나 회계상 문제가 발생하면 경고하는 방식으로 자금 누수을 예방한다고 주장합니다. 그러나 이러한 방식은 감사시스템과 마찬가지로 CEO나 오너의 직접 확인이 어렵고, 조작이나 은폐에 취약하며, 다양한 방식의 자금 누수에 대처하거나 탐지하기 어렵다는 한계가 있습니다. 무엇보다 GOTCHOO는 작은 규모의 기업이나 비영리기관·단체·사업체에서도 사용할 수 있는, 범용성과 확장성이 뛰어난 프로그램입니다.",
    },
    {
      question: "GOTCHOO를 이용하려면 어떻게 해야 하나요?",
      answer:
        "홈페이지에서 회원가입 및 설치플랜을 선택하신 후 GOTCHOO 설치파일을 다운로드 받아 실행시키면 PC에 설치할 수 있습니다. 설치 후 바탕화면에 생긴 GOTCHOO 아이콘을 클릭하시면 프로그램이 실행됩니다. 실행후 안내에 따라 기업/기관위치, 급여일, 은행계좌, 신용카드, 홈택스, 4대사회보험, 직원정보를 등록하고, 알람/리포트 수신정보와 탐지주기를 설정하면 미리 설정된 주기에 따라 자동으로 거래내역을 수집 분석하여 자금 누수 등 부정행위 의심거래를 탐지하여 드립니다. 최초 사용자 등록후 3개월동안 무료로 이용하실 수 있습니다.",
    },
  ];
        ...
        <div className="max-w-5xl w-full text-center space-y-12">
          <div className="space-y-6">
            ...
            <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300">
              금융 데이터 분석으로 한눈에 자금 누수를 잡아내는 똑똑한 솔루션
            </p>
